#' Estimate Genetic Network Using MCP-Penalized D-Trace Loss Function
#'
#' The \code{entropy.mcp.spearman.sampling} function estimates the genetic network by applying a penalized D-trace loss function using MCP (Minimax Concave Penalty). It's designed to work with genetic data, specifically effect size estimates or Z-scores for various exposures across multiple variants.
#'
