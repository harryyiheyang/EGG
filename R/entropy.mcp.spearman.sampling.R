...
#'
#' The \code{entropy.mcp.spearman.sampling} function estimates the genetic network by applying a penalized entropy loss function using MCP (Minimax Concave Penalty). It's designed to work with genetic data, specifically effect size estimates or Z-scores for various exposures across multiple variants.
#'
...
#' @param mineig The minimum eigenvalue for the precision matrix estimate. Default is 0.01.
...
#' @export
#'
entropy.mcp.spearman.sampling=function(BETA,Rnoise,lamvec=c(1:20)/100,max.eps=0.01,max.iter=25,rho=0.05,mineig=0.01,subtime=100,subfrac=0.5,subthres=0.95,alpha=0,reliability.thres=0.8,PenaMatrix="none"){
