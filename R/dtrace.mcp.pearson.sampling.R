...
#' @export
#'
dtrace.mcp.pearson.sampling=function(BETA,Rnoise,lamvec=c(1:20)/100,max.eps=0.01,max.iter=25,rho=0.05,mineig=0.01,subtime=100,subfrac=0.5,subthres=0.95,alpha=0,bic.factor=0.5,reliability.thres=0.8,PenaMatrix="none"){
  BETA=as.matrix(BETA)
